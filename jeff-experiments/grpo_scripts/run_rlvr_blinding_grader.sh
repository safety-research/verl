...
python -m verl.trainer.main_ppo \
    ...
    custom_reward_function.path=$HOME/sky_workdir/verl/examples/ppo_trainer/math_grader_reward.py \
    custom_reward_function.name=compute_math_grader_reward \
    reward_model.reward_manager=batch \
    +reward_model.reward_kwargs.pass_prompt=True \
    +reward_model.reward_kwargs.judge=blinding \
